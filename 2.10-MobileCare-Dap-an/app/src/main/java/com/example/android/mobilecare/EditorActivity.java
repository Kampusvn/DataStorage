...
/**
 * Cho phép người dùng thêm mới hoặc chỉnh sửa thông tin thiết bị.
 */
public class EditorActivity extends AppCompatActivity {
    ...
    /** EditText cho hãng của thiết bị */
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.os_android))) {
                        mOS = MobileEntry.OS_ANDROID; // Android
                    } else if (selection.equals(getString(R.string.os_ios))) {
                        mOS = MobileEntry.OS_IOS; // iOS
                    } else {
                        mOS = MobileEntry.OS_OTHER; // Khác
                    }
                }
            }
