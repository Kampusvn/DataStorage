...
public final class MobileContract {
    ...
    public static final class MobileEntry implements BaseColumns {
        ...
        /**
         * MIME type của {@link #CONTENT_URI} cho danh sách thiết bị.
         */
        public static final String CONTENT_LIST_TYPE =
                ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_MOBILE;

        /**
         * MIME type của {@link #CONTENT_URI} cho một thiết bị đơn lẻ.
         */
        ...
        /**
         * Trả về OS {@link #OS_ANDROID}, {@link #OS_IOS}, hoặc {@link #OS_OTHER}.
         */
        public static boolean isValidOs(int os) {
            if (os == OS_ANDROID || os == OS_IOS || os == OS_OTHER) {
                return true;
            }
            return false;
        }
